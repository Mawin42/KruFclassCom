            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    <div class="breadcrumb-text">
                        <h3>หมวดหมู่: <span>ภาพกิจกรรมภายนอกโรงเรียน</span></h3>
                        <div class="bt-option">
                            <a href="#">Home</a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 p-0">
                    <?php 
                    $sql = "SELECT * FROM externaljpg";
                    $result = $con->query($sql);
                    ?>
                    <?php while($row = $result->fetch_assoc()): ?>
                    <div class="cl-item">
                        <div class="cl-pic">
                            <img src="kkexternal/<?php echo $row['imgexternal'];?>" alt="">
                        </div>
                        <div class="cl-text">
                            <div class="label"><span>Reviews</span></div>
                            <h5><a href="#"><?php echo $row['nameexternal'];?></a></h5>
                            <ul>
                                <li>by <span>Admin</span></li>
                                <li><i class="fa fa-clock-o"></i> <?php echo $row['dateexternal'];?></li>
                                <li><i class="fa fa-comment-o"></i> <?php echo $row['dgexternal'];?></li>
                            </ul>
                            <p><?php echo $row['lnameexternal'];?></p>
                        </div>
                    </div>
                    <?php endwhile ?>
