                ...
                <div class="col-lg-8 p-0">
                    <div class="details-text gallery-page">
                        <div class="dt-title-gallery details-hero-text">
                            ...
                            <h3>วิทยาการคำนวณ ม.2 หน่วยการเรียนรู้ที่ 3 ระบบคอมพิวเตอร์</h3>
                            <ul>
                        ...
                        <div class="dt-desc" >
                            ...
                            <div class="btnn"><a href="#" style="font-family: 'Sarabun', sans-serif;" >1 องค์ประกอบของระบบคอมพิวเตอร์</a></div>
                            <br>
                            <div class="btnn"><a href="#" style="font-family: 'Sarabun', sans-serif;" >2 หลักการทำงานของระบบคอมพิวเตอร์</a></div>
                            <br>
                            <div class="btnn"><a href="#" style="font-family: 'Sarabun', sans-serif;" > 3 เทคโนโลยีการสื่อสาร</a></div>
                            <br>
                            <div class="btnn"><a href="#" style="font-family: 'Sarabun', sans-serif;" >4 การประยุกต์ใช้งานและการแก้ปัญหาเบื้องต้น</a></div>
                            <br><br>
                            <br><br>
